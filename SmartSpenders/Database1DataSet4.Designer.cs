...
namespace SmartSpenders {
    ...
    public partial class Database1DataSet4 : global::System.Data.DataSet {
        ...
        public partial class categoriesDataTable : global::System.Data.TypedTableBase<categoriesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public categoriesRow AddcategoriesRow(string Username, string Category, int Spending) {
        ...
        public partial class categoriesRow : global::System.Data.DataRow {
            ...
            public string Username {
                get {
                    return ((string)(this[this.tablecategories.UsernameColumn]));
                }
                set {
                    this[this.tablecategories.UsernameColumn] = value;
                }
            }
            ...
            public int Spending {
                get {
                    return ((int)(this[this.tablecategories.SpendingColumn]));
                }
                set {
                    this[this.tablecategories.SpendingColumn] = value;
                }
            }
        }
...
namespace SmartSpenders.Database1DataSet4TableAdapters {
    ...
    public partial class categoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[categories] WHERE (([Id] = @Original_Id) AND ([Username] = @Or" +
                "iginal_Username) AND ([Category] = @Original_Category) AND ([Spending] = @Origin" +
                "al_Spending))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[categories] ([Username], [Category], [Spending]) VALUES (@User" +
                "name, @Category, @Spending);\r\nSELECT Id, Username, Category, Spending FROM categ" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[categories] SET [Username] = @Username, [Category] = @Category, [Spending] = @Spending WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Category] = @Original_Category) AND ([Spending] = @Original_Spending));
SELECT Id, Username, Category, Spending FROM categories WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Category, Spending FROM dbo.categories";
        ...
        public virtual int Fill(Database1DataSet4.categoriesDataTable dataTable) {
        ...
        public virtual Database1DataSet4.categoriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet4.categoriesDataTable dataTable = new Database1DataSet4.categoriesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet4.categoriesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Username, string Original_Category, int Original_Spending) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_Spending));
        ...
        public virtual int Insert(string Username, string Category, int Spending) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Category, int Spending, int Original_Id, string Original_Username, string Original_Category, int Original_Spending, int Id) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_Spending));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Category, int Spending, int Original_Id, string Original_Username, string Original_Category, int Original_Spending) {
            return this.Update(Username, Category, Spending, Original_Id, Original_Username, Original_Category, Original_Spending, Original_Id);
        }
    }
