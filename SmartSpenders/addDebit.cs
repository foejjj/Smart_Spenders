...
namespace SmartSpenders
{
    public partial class addDebit : Form
    {
        ...
        public addDebit(string username)
        {
            InitializeComponent();
        ...
        private void enterButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string query = "INSERT into debit ([Username], [Name], [Amount]) values(@username, @name, @amount)";
        ...
        private void addDebit_Load(object sender, EventArgs e)
        {
