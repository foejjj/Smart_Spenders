...
namespace SmartSpenders {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class transactionDataTable : global::System.Data.TypedTableBase<transactionRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public transactionRow AddtransactionRow(string Username, string Category, string Account, string Note, int Amount, System.DateTime CreatedDate) {
...
namespace SmartSpenders.Database1DataSetTableAdapters {
    ...
    public partial class transactionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[transaction] WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Category] = @Original_Category) AND ([Account] = @Original_Account) AND ([Note] = @Original_Note) AND ([Amount] = @Original_Amount) AND ([CreatedDate] = @Original_CreatedDate))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[transaction] ([Username], [Category], [Account], [Note], [Amount], [CreatedDate]) VALUES (@Username, @Category, @Account, @Note, @Amount, @CreatedDate);
SELECT Id, Username, Category, Account, Note, Amount, CreatedDate FROM [transaction] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[transaction] SET [Username] = @Username, [Category] = @Category, [Account] = @Account, [Note] = @Note, [Amount] = @Amount, [CreatedDate] = @CreatedDate WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Category] = @Original_Category) AND ([Account] = @Original_Account) AND ([Note] = @Original_Note) AND ([Amount] = @Original_Amount) AND ([CreatedDate] = @Original_CreatedDate));
SELECT Id, Username, Category, Account, Note, Amount, CreatedDate FROM [transaction] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Category, Account, Note, Amount, CreatedDate FROM dbo.[trans" +
                "action]";
        ...
        public virtual int Fill(Database1DataSet.transactionDataTable dataTable) {
        ...
        public virtual Database1DataSet.transactionDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.transactionDataTable dataTable = new Database1DataSet.transactionDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.transactionDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Username, string Original_Category, string Original_Account, string Original_Note, int Original_Amount, System.DateTime Original_CreatedDate) {
        ...
        public virtual int Insert(string Username, string Category, string Account, string Note, int Amount, System.DateTime CreatedDate) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Category, string Account, string Note, int Amount, System.DateTime CreatedDate, int Original_Id, string Original_Username, string Original_Category, string Original_Account, string Original_Note, int Original_Amount, System.DateTime Original_CreatedDate, int Id) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Category, string Account, string Note, int Amount, System.DateTime CreatedDate, int Original_Id, string Original_Username, string Original_Category, string Original_Account, string Original_Note, int Original_Amount, System.DateTime Original_CreatedDate) {
            return this.Update(Username, Category, Account, Note, Amount, CreatedDate, Original_Id, Original_Username, Original_Category, Original_Account, Original_Note, Original_Amount, Original_CreatedDate, Original_Id);
        }
    }
