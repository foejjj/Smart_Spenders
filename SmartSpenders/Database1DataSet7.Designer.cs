...
namespace SmartSpenders {
    ...
    public partial class Database1DataSet7 : global::System.Data.DataSet {
        ...
        public partial class creditDataTable : global::System.Data.TypedTableBase<creditRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public creditRow AddcreditRow(string Username, string Name, int Amount) {
        ...
        public partial class creditRow : global::System.Data.DataRow {
            ...
            public string Username {
                get {
                    return ((string)(this[this.tablecredit.UsernameColumn]));
                }
                set {
                    this[this.tablecredit.UsernameColumn] = value;
                }
            }
            ...
            public string Name {
                get {
                    return ((string)(this[this.tablecredit.NameColumn]));
                }
                set {
                    this[this.tablecredit.NameColumn] = value;
                }
            }
...
namespace SmartSpenders.Database1DataSet7TableAdapters {
    ...
    public partial class creditTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[credit] WHERE (([Id] = @Original_Id) AND ([Username] = @Origin" +
                "al_Username) AND ([Name] = @Original_Name) AND ([Amount] = @Original_Amount))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[credit] ([Username], [Name], [Amount]) VALUES (@Username, @Nam" +
                "e, @Amount);\r\nSELECT Id, Username, Name, Amount FROM credit WHERE (Id = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[credit] SET [Username] = @Username, [Name] = @Name, [Amount] = @Amount WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Name] = @Original_Name) AND ([Amount] = @Original_Amount));
SELECT Id, Username, Name, Amount FROM credit WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Name, Amount FROM dbo.credit";
        ...
        public virtual int Fill(Database1DataSet7.creditDataTable dataTable) {
        ...
        public virtual Database1DataSet7.creditDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet7.creditDataTable dataTable = new Database1DataSet7.creditDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet7.creditDataTable dataTable) {
